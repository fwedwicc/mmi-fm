...
const ImportPublishersModal = ({ isOpen, onClose, onImport }) => {
  ...
  const handleImport = () => {
    onImport(parsedRows)
    showToast.success('Publishers imported successfully!')
    closeModal()
  }
    ...
    >
      <div className='px-2 pb-2'>
        ...
        <div className='mt-3.5 space-y-1 text-xs'>
          <button
            type='button'
            onClick={downloadPublishersCsvTemplate}
...
export default ImportPublishersModal
